...
$BackupRootPath = "\\BackupSvr.azure.imanagework.co.uk\Backup\Test"
...
# Set performance configuration for all volumes as Incremental
Set-WBPerformanceConfiguration -OverallPerformanceSetting AlwaysIncremental

Set-WBSchedule -Policy $WBPolicy -Schedule 12:00,09:00
