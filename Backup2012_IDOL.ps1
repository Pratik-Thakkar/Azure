...
$Volume1 = Get-WBVolume -VolumePath G:
$Volume2 = Get-WBVolume -VolumePath H:
...
Add-WBVolume -Policy $WBPolicy -Volume $Volume1
Add-WBVolume -Policy $WBPolicy -Volume $Volume2
